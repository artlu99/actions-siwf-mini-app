/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: cbcfb60207b2896f867bbf3d45bf4b96)
// Runtime types generated with workerd@1.20250410.0 2025-04-14 
declare namespace Cloudflare {
	interface Env {
		KV: KVNamespace;
		MY_VAR: "Hello from Hono 🔥 on Cloudflare Workers";
		JWT_ALGORITHM: "HS256";
		BASE_URL: "https://actions-siwf.artlu.workers.dev";
		DECENT_BOOKMARKS_SECRET: string;
		SECRET: string;
